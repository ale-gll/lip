...
(* #### Exercise 3 *)
let%test "balanced_parentheses_1" = derive balanced_parentheses [ 3;3;0;4;1;4;2;4 ] |> to_string = "()[]{}"
let%test "balanced_parentheses_2" = derive balanced_parentheses [ 3;0;2;4;1;4; ] |> to_string = "({})[]"
let%test "balanced_parentheses_3" = derive balanced_parentheses [ 0;2;3;1;4;1;3;2;4;0;4 ] |> to_string = "({[][{}()]})"

(* #### Exercise 4 *)
let%test "zero_one_same_1" = derive same_amount [ 3; ] |> to_string = ""
let%test "zero_one_same_2" = derive same_amount [ 2;1;3;0;3 ] |> to_string = "1001"
let%test "zero_one_same_3" = derive same_amount [ 2;0;0;3;2;0;3;0;3 ] |> to_string = "00110101"
let%test "zero_one_same_4" = derive same_amount [ 2;1;3;2;0;0;3;1;3 ] |> to_string = "10001110"
